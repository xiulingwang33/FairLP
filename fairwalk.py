...
from fairwalk import link_prediction_scores
...
for node in g_train.nodes():
    for nbr in sorted(g_train.neighbors(node)):
        g_train[node][nbr]['weight']=1


n2v_scores, val_edge_labels, val_preds, test_edge_labels, test_preds= link_prediction_scores.fairwalk_scores(
    g_train, train_test_split,DATA,
