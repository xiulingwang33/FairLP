...
from FairLP import *
from node2vec import link_prediction_scores
...
for METHOD in METHODS:
    ...
    n2v_scores, val_edge_labels, val_preds, test_edge_labels, test_preds = link_prediction_scores.node2vec_scores(
        g_copy, train_test_split, DATA,
